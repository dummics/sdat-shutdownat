...
- Refined the quick palette with reliable foreground text focus, global Escape dismissal while visible, a fixed non-draggable layout, persistent desktop acrylic when unfocused, no bright native window outline, a nearly invisible in-app edge, stronger entrance/exit motion, and transient success feedback that does not reappear on reopen.
